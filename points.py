...
def figure4(N=1000):
	...
	point_generation(axs[0,4], N=N, show=POINTS, dt=dt_iter, iter=iter, noise_scale=s_iter)
	point_generation(axs[0,1], N=N, iter=-1, show=POINTS)
	point_generation(axs[0,2], N=N, iter=-3, show=POINTS)
	point_generation(axs[0,3], N=N, iter=-4, show=POINTS)
